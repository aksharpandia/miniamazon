...
product2 = Product(123456790, 1, '16-inch MacBook Pro', 'img2.jpg', '16" MacBook Pro', 2, False, 1200.00)
db.session.add(product2)
product3 = Product(123456791, 1, '11-inch MacBook Air', 'img6.jpg', '11" MacBook Air', 2, False, 1200.00)
db.session.add(product3)
product4 = Product(123456792, 1, '13-inch MacBook Air', 'img7.jpg', '13" MacBook Air', 2, True, 1200.00)
db.session.add(product4)
product5 = Product(246468680, 2, 'iPhone 11 w/ 64GB of storage', 'img3.jpg', '64GB iPhone 11', 4, False, 900.00)
db.session.add(product5)
product6 = Product(246468681, 2, 'iPhone 11 w/ 128GB of storage', 'img4.jpg', '128GB iPhone 11', 4, True, 900.00)
db.session.add(product6)
product7 = Product(246468682, 2, 'iPhone 11 w/ 256GB of storage', 'img5.jpg', '256GB iPhone 11', 4, True, 900.00)
db.session.add(product7)
product8 = Product(135357579, 3, '12.9-inch iPad Pro (4th generation)', 'img8.jpg', 'iPad Pro 4th Generation', 4, True, 800.00)
db.session.add(product8)
product9 = Product(135357580, 3, '10.9-inch iPad Air (4th generation)', 'img9.jpg', 'iPad Air 4th Generation', 2, False, 800.00)
db.session.add(product9)
product10 = Product(135357581, 3, '10.2-inch iPad (8th generation)', 'img10.jpg', 'iPad 8th Generation', 2, False, 700.00)
