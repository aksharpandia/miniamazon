...
item2 = Item(123000002, False, 123456789, 1) 
db.session.add(item2)
item3 = Item(123000003, False, 123456790, 1) 
db.session.add(item3)
item4 = Item(123000004, False, 123456791, 1) 
db.session.add(item4)
item5 = Item (246000001, False, 123456792, 1,) 
db.session.add(item5)
item6 = Item (246000002, False, 246468680, 2,) 
db.session.add(item6)
item7 = Item (246000003, False, 246468680, 2,) 
db.session.add(item7)
item8 = Item (135000001, False, 246468681, 2,) 
db.session.add(item8)
item9 = Item (135000002, False, 246468681, 2) 
...
item15 = Item (579000001, False, 135357579, 3) 
db.session.add(item15)
item16 = Item (579000002, False, 135357579, 3) 
db.session.add(item16)
item17 = Item (579000003, False, 135357580, 3) 
db.session.add(item17)
item18 = Item (791000001, False, 135357580, 3) 
