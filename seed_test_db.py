...
user1 = User("jessica", "jessica.su@duke.edu", "password", "seller", "10-10-2020")
db.session.add(user1)
user2 = User("kassen", "kassen.qian@duke.edu", "password", "seller", "10-11-2020")
db.session.add(user2)
user3 = User("aayush", "aayush.goradia@duke.edu", "password", "seller", "10-12-2020")
db.session.add(user3)
user4 = User("nathan", "nathan.parikh@duke.edu", "password", "buyer", "10-13-2020")
db.session.add(user4)
user5 = User("akshar", "akshar.pandia@duke.edu", "password", "buyer", "10-14-2020")
db.session.add(user5)
user6 = User("another buyer", "another.buyer@duke.edu", "password", "buyer", "10-15-2020")
