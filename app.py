...
from forms import AddProductForm # insert other forms here
from forms import AddUserForm
...
if ENV == 'dev':
    ...
    app.debug=False
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://mkviwitarozyhn:38713ef99ca2a3a311ad1347a209e9f835e5274a4e56b27e3339cce74b83b25d@ec2-54-164-134-207.compute-1.amazonaws.com:5432/d1t2veoljp2rnf'


app.config['SECRET_KEY'] = 'randomstringforkey'
